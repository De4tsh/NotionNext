...
const BLOG = {
  AUTHOR: 'SHTWO', // 作者
  BIO: 'De4tshの小站', // 作者简介
  LINK: 'https://shtwo.top', // 网站地址
  KEYWORDS: 'Notion,技术,博客,华为,HCIE', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '05fd40f5b96441c99c3a5f784d88e06b', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'dann84033@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/De4tsh',
  CONTACT_TELEGRAM: 'https://t.me/asikden',
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://my-waline-eight-lime.vercel.app/', // Waline 评论 @see https://waline.js.org/guide/get-started.html
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'SHTWO', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '一起学习一起进步', // 站点描述，被notion中的页面描述覆盖
